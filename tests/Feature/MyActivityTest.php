...
class MyActivityTest extends TestCase
{
    ...
    public function test_my_activities_does_not_show_other_users_activities(): void
    {
    ...
    public function test_my_activities_shows_order_by_time_correctly(): void
    {
        $user = User::factory()->create();
    ...
    public function test_cannot_cancel_activity_for_other_user(): void
    {
        $user = User::factory()->create();
        $activity = Activity::factory()->create();
        $user->activities()->attach($activity);
