...
class GuideActivityTest extends TestCase
{
    ...
    public function test_guide_can_access_my_activities_page(): void
    {
    ...
    public function test_other_user_cannot_access_guide_activities_page():void
    {
    ...
    public function test_guide_sees_activities_ordered_by_time_correctly(): void
    {
        $user = User::factory()->guide()->create();
        ...
        $activity3 = Activity::factory()->create(['guide_id' => $user->id, 'start_time' => now()->addMonth(2)]);
